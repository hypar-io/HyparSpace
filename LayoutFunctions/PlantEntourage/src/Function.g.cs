...
namespace PlantEntourage
{
    public class Function
    {
        ...
        private UrlModelStore<PlantEntourageInputs> store;

        public async Task<PlantEntourageOutputs> Handler(PlantEntourageInputs args)
        {
            ...
            if(this.store == null)
            {
                this.store = new UrlModelStore<PlantEntourageInputs>();
            }
