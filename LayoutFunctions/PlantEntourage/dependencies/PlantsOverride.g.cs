...
{
	/// <summary>
	/// Override metadata for PlantsOverride
	/// </summary>
	public partial class PlantsOverride : IOverride
	{
        public static string Name = "Plants";
	...
	public static class PlantsOverrideExtensions
    {
		/// <summary>
        /// Apply Plants edit overrides to a collection of existing elements
        /// </summary>
        /// <param name="overrideData">The Plants Overrides to apply</param>
        ...
        public static List<T> Apply<T>(
            this IList<PlantsOverride> overrideData,
            IEnumerable<T> existingElements,
            Func<T, PlantsIdentity, bool> identityMatch,
            Func<T, PlantsOverride, T> modifyElement) where T : Element
        {
        ...
        /// </summary>
        /// <param name="existingElements">A collection of existing elements to which to apply the overrides.</param>
        /// <param name="overrideData">The Plants Overrides to apply — typically `input.Overrides.Plants`</param>
        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        /// <param name="modifyElement">A function to modify a matched element, returning the modified element.</param>
        /// <typeparam name="T">The element type this override applies to. Should match the type(s) in the override's context.</typeparam>
        /// <returns>A collection of elements, including unmodified and modified elements from the supplied collection.</returns>
        public static void ApplyOverrides<T>(
            ...
            IList<PlantsOverride> overrideData,
            Func<T, PlantsIdentity, bool> identityMatch,
            Func<T, PlantsOverride, T> modifyElement
            ) where T : Element
        {
        ...
        /// </summary>
        /// <param name="edits">The collection of edit overrides (Overrides.Plants)</param>
        /// <param name="additions">The collection of add overrides (Overrides.Additions.Plants)</param>
        /// <param name="removals">The collection of remove overrides (Overrides.Removals.Plants)</param>        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        ...
        public static List<T> CreateElements<T>(
            this IList<PlantsOverride> edits,
            IList<PlantsOverrideAddition> additions,
            IList<PlantsOverrideRemoval> removals,            Func<PlantsOverrideAddition, T> createElement,
            Func<T, PlantsIdentity, bool> identityMatch,
            Func<T, PlantsOverride, T> modifyElement,
