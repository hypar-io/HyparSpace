...
namespace PantryLayout
{
    public class PantryLayoutTest
    {
        ...
        public void TestExecute()
        {
            ...
            var result = PantryLayout.Execute(modelDependencies, input);
            result.Model.ToGlTF("../../../Generated/PantryLayoutTest/results/PantryLayoutTest.glb");
            File.WriteAllText("../../../Generated/PantryLayoutTest/results/PantryLayoutTest.json", result.Model.ToJson());
        }
