...
namespace Doors
{
    public class Function
    {
        ...
        private IModelStore<DoorsInputs> store;

        public async Task<DoorsOutputs> Handler(DoorsInputs args, ILambdaContext context)
        {
            ...
            { 
                ...
                {
                    this.store = new UrlModelStore<DoorsInputs>();
                }
            }
