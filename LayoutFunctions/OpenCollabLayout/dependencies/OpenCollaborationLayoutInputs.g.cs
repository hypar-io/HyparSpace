...
namespace OpenCollaborationLayout
{
    ...
    public  class OpenCollaborationLayoutInputs : ArgsBase
    
    {
        [Newtonsoft.Json.JsonConstructor]
        
        public OpenCollaborationLayoutInputs(Overrides @overrides, Dictionary<string, string> modelInputKeys, string gltfKey, string elementsKey, string ifcKey):
