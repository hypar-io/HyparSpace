...
namespace Elements
{
    ...
    public partial class SpaceBoundary : GeometricElement
    {
        ...
        public SpaceBoundary(Profile @boundary, IList<Polygon> @cells, Transform @transform, Material @material, Representation @representation, bool @isElementDefinition, System.Guid @id, string @name)
