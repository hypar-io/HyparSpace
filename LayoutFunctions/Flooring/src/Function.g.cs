...
namespace Flooring
{
    public class Function
    {
        ...
        private UrlModelStore<FlooringInputs> store;

        public async Task<FlooringOutputs> Handler(FlooringInputs args)
        {
            ...
            if(this.store == null)
            {
                this.store = new UrlModelStore<FlooringInputs>();
            }
            

            var l = new InvocationWrapper<FlooringInputs,FlooringOutputs> (store, Flooring.Execute);
