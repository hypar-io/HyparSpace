...
{
	/// <summary>
	/// Override metadata for FloorTypesOverride
	/// </summary>
	public partial class FloorTypesOverride : IOverride
	{
        public static string Name = "Floor Types";
	...
	public static class FloorTypesOverrideExtensions
    {
		/// <summary>
        /// Apply Floor Types edit overrides to a collection of existing elements
        /// </summary>
        /// <param name="overrideData">The Floor Types Overrides to apply</param>
        ...
        public static List<T> Apply<T>(
            this IList<FloorTypesOverride> overrideData,
            IEnumerable<T> existingElements,
            Func<T, FloorTypesIdentity, bool> identityMatch,
            Func<T, FloorTypesOverride, T> modifyElement) where T : Element
        {
        ...
        /// </summary>
        /// <param name="existingElements">A collection of existing elements to which to apply the overrides.</param>
        /// <param name="overrideData">The Floor Types Overrides to apply — typically `input.Overrides.FloorTypes`</param>
        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        /// <param name="modifyElement">A function to modify a matched element, returning the modified element.</param>
        /// <typeparam name="T">The element type this override applies to. Should match the type(s) in the override's context.</typeparam>
        /// <returns>A collection of elements, including unmodified and modified elements from the supplied collection.</returns>
        public static void ApplyOverrides<T>(
            ...
            IList<FloorTypesOverride> overrideData,
            Func<T, FloorTypesIdentity, bool> identityMatch,
            Func<T, FloorTypesOverride, T> modifyElement
            ) where T : Element
        {
        ...
        /// </summary>
        /// <param name="edits">The collection of edit overrides (Overrides.FloorTypes)</param>
        /// <param name="additions">The collection of add overrides (Overrides.Additions.FloorTypes)</param>
        /// <param name="removals">The collection of remove overrides (Overrides.Removals.FloorTypes)</param>        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        ...
        public static List<T> CreateElements<T>(
            this IList<FloorTypesOverride> edits,
            IList<FloorTypesOverrideAddition> additions,
            IList<FloorTypesOverrideRemoval> removals,            Func<FloorTypesOverrideAddition, T> createElement,
            Func<T, FloorTypesIdentity, bool> identityMatch,
            Func<T, FloorTypesOverride, T> modifyElement,
