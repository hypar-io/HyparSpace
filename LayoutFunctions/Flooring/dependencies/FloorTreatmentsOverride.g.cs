...
{
	/// <summary>
	/// Override metadata for FloorTreatmentsOverride
	/// </summary>
	public partial class FloorTreatmentsOverride : IOverride
	{
        public static string Name = "Floor Treatments";
	...
	public static class FloorTreatmentsOverrideExtensions
    {
		/// <summary>
        /// Apply Floor Treatments edit overrides to a collection of existing elements
        /// </summary>
        /// <param name="overrideData">The Floor Treatments Overrides to apply</param>
        ...
        public static List<T> Apply<T>(
            this IList<FloorTreatmentsOverride> overrideData,
            IEnumerable<T> existingElements,
            Func<T, FloorTreatmentsIdentity, bool> identityMatch,
            Func<T, FloorTreatmentsOverride, T> modifyElement) where T : Element
        {
        ...
        /// </summary>
        /// <param name="existingElements">A collection of existing elements to which to apply the overrides.</param>
        /// <param name="overrideData">The Floor Treatments Overrides to apply — typically `input.Overrides.FloorTreatments`</param>
        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        /// <param name="modifyElement">A function to modify a matched element, returning the modified element.</param>
        /// <typeparam name="T">The element type this override applies to. Should match the type(s) in the override's context.</typeparam>
        /// <returns>A collection of elements, including unmodified and modified elements from the supplied collection.</returns>
        public static void ApplyOverrides<T>(
            ...
            IList<FloorTreatmentsOverride> overrideData,
            Func<T, FloorTreatmentsIdentity, bool> identityMatch,
            Func<T, FloorTreatmentsOverride, T> modifyElement
            ) where T : Element
        {
        ...
        /// </summary>
        /// <param name="edits">The collection of edit overrides (Overrides.FloorTreatments)</param>
        /// <param name="additions">The collection of add overrides (Overrides.Additions.FloorTreatments)</param>
        /// <param name="removals">The collection of remove overrides (Overrides.Removals.FloorTreatments)</param>        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        ...
        public static List<T> CreateElements<T>(
            this IList<FloorTreatmentsOverride> edits,
            IList<FloorTreatmentsOverrideAddition> additions,
            IList<FloorTreatmentsOverrideRemoval> removals,            Func<FloorTreatmentsOverrideAddition, T> createElement,
            Func<T, FloorTreatmentsIdentity, bool> identityMatch,
            Func<T, FloorTreatmentsOverride, T> modifyElement,
