...
namespace TravelDistanceAnalyzer
{
    public class Function
    {
        ...
        private UrlModelStore<TravelDistanceAnalyzerInputs> store;

        public async Task<TravelDistanceAnalyzerOutputs> Handler(TravelDistanceAnalyzerInputs args)
        {
            ...
            if(this.store == null)
            {
                this.store = new UrlModelStore<TravelDistanceAnalyzerInputs>();
            }
            

            var l = new InvocationWrapper<TravelDistanceAnalyzerInputs,TravelDistanceAnalyzerOutputs> (store, TravelDistanceAnalyzer.Execute);
