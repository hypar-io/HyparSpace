...
{
	/// <summary>
	/// Override metadata for WalkingDistanceOverride
	/// </summary>
	public partial class WalkingDistanceOverride : IOverride
	{
        public static string Name = "Walking Distance";
	...
	public static class WalkingDistanceOverrideExtensions
    {
		/// <summary>
        /// Apply Walking Distance edit overrides to a collection of existing elements
        /// </summary>
        /// <param name="overrideData">The Walking Distance Overrides to apply</param>
        ...
        public static List<T> Apply<T>(
            this IList<WalkingDistanceOverride> overrideData,
            IEnumerable<T> existingElements,
            Func<T, WalkingDistanceIdentity, bool> identityMatch,
            Func<T, WalkingDistanceOverride, T> modifyElement) where T : Element
        {
        ...
        /// </summary>
        /// <param name="existingElements">A collection of existing elements to which to apply the overrides.</param>
        /// <param name="overrideData">The Walking Distance Overrides to apply — typically `input.Overrides.WalkingDistance`</param>
        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        /// <param name="modifyElement">A function to modify a matched element, returning the modified element.</param>
        /// <typeparam name="T">The element type this override applies to. Should match the type(s) in the override's context.</typeparam>
        /// <returns>A collection of elements, including unmodified and modified elements from the supplied collection.</returns>
        public static void ApplyOverrides<T>(
            ...
            IList<WalkingDistanceOverride> overrideData,
            Func<T, WalkingDistanceIdentity, bool> identityMatch,
            Func<T, WalkingDistanceOverride, T> modifyElement
            ) where T : Element
        {
        ...
        /// </summary>
        /// <param name="edits">The collection of edit overrides (Overrides.WalkingDistance)</param>
        /// <param name="additions">The collection of add overrides (Overrides.Additions.WalkingDistance)</param>
        /// <param name="removals">The collection of remove overrides (Overrides.Removals.WalkingDistance)</param>        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        ...
        public static List<T> CreateElements<T>(
            this IList<WalkingDistanceOverride> edits,
            IList<WalkingDistanceOverrideAddition> additions,
            IList<WalkingDistanceOverrideRemoval> removals,            Func<WalkingDistanceOverrideAddition, T> createElement,
            Func<T, WalkingDistanceIdentity, bool> identityMatch,
            Func<T, WalkingDistanceOverride, T> modifyElement,
