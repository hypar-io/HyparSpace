...
namespace SpaceConfigurationFromModel
{
    public class Function
    {
        ...
        private IModelStore<SpaceConfigurationFromModelInputs> store;

        public async Task<SpaceConfigurationFromModelOutputs> Handler(SpaceConfigurationFromModelInputs args, ILambdaContext context)
        {
