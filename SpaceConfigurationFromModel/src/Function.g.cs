...
namespace SpaceConfigurationFromModel
{
    public class Function
    {
        ...
        private UrlModelStore<SpaceConfigurationFromModelInputs> store;

        public async Task<SpaceConfigurationFromModelOutputs> Handler(SpaceConfigurationFromModelInputs args)
        {
