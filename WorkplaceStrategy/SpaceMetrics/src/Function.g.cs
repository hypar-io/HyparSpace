...
namespace SpaceMetrics
{
    public class Function
    {
        ...
        private UrlModelStore<SpaceMetricsInputs> store;

        public async Task<SpaceMetricsOutputs> Handler(SpaceMetricsInputs args)
        {
            ...
            if(this.store == null)
            {
                this.store = new UrlModelStore<SpaceMetricsInputs>();
            }
            

            var l = new InvocationWrapper<SpaceMetricsInputs,SpaceMetricsOutputs> (store, SpaceMetrics.Execute);
