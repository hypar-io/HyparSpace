...
namespace DefineProgramRequirements
{
    public class Function
    {
        ...
        private UrlModelStore<DefineProgramRequirementsInputs> store;

        public async Task<DefineProgramRequirementsOutputs> Handler(DefineProgramRequirementsInputs args)
        {
