...
namespace WorkplaceMetrics
{
    public class Function
    {
        ...
        private UrlModelStore<WorkplaceMetricsInputs> store;

        public async Task<WorkplaceMetricsOutputs> Handler(WorkplaceMetricsInputs args)
        {
            ...
            if(this.store == null)
            {
                this.store = new UrlModelStore<WorkplaceMetricsInputs>();
            }
