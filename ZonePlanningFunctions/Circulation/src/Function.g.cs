...
namespace Circulation
{
    public class Function
    {
        ...
        private IModelStore<CirculationInputs> store;

        public async Task<CirculationOutputs> Handler(CirculationInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<CirculationInputs>(RegionEndpoint.USWest1);
            }
