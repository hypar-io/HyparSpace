...
namespace Elements
{
    ...
    public partial class AreaTally : Element
    {
        ...
        public AreaTally(string @programType, Color @programColor, double @areaTarget, double @achievedArea, double @distinctAreaCount, string @cost, System.Guid @id, string @name)
            : base(id, name)
        {
